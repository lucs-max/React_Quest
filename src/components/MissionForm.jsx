...
function MissionForm({ onAddMission , editingMission,onUpdateMission }) {
    ...
    function handleSubmit(event) {
        ...
        if (editingMission) {
            onUpdateMission({ ...newMission, id: editingMission.id,completed: editingMission.completed });
        }else{
    ...
    return (
        <section className="mission-form-section">
            <div className="mission-form-heading">
                <p>Nova Missão</p>
                <h2>Crie a sua propria missao</h2>
            </div>
            <form className="mission-form" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="mission-form__button">
                    {editingMission ? "Atualizar Missão" : "Adicionar Missão"}
                </button>
            </form>
        </section>
    )
